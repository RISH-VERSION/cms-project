        ...
        <header className="bg-gray-800 text-white py-4">
            <div className="container mx-auto flex justify-between items-center px-4">
                ...
                <div className="flex space-x-6">
                    <button className="text-white hover:text-gray-300 font-semibold">Sign-in</button>
                    <button className="text-white hover:text-gray-300 font-semibold">Sign-out</button>
                </div>
            </div>
        </header>
